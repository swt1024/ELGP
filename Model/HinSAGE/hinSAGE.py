...
# Tuning hyperparameters
 ...
 lncRNAs = pd.read_csv(f"../../Annotate/mouse/valid_MEL_annotation.csv")
...
#human_cell_lines=['HepG2','HeLa']
#mouse_cell_lines=['CH12.LX','ES-E14']
#species = 'mouse'

#for cell_line in mouse_cell_lines:

#    proteins = pd.read_csv(f"../../Annotate/{species}/transformed_protein_annotation.csv")
#    lncRNAs = pd.read_csv(f"../../Annotate/{species}/valid_{cell_line}_annotation.csv")
...
#    node_embedding = run_deep_graph_infomax(hinsage_model, hinsage_generator, epochs=epochs)
#    embedding_df = pd.DataFrame(node_embedding, index=LPPI_graph.nodes(node_type='lncRNA'))
#    embedding_df.to_csv(f'./{species}/lncRNA_embeddings_{cell_line}.csv', header=None)