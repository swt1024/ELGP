...
# File paths
X_path = f'../../Model/HinSAGE/mouse/lncRNA_embeddings_lung.csv'
...
save_path = 'mlp_mouse_lung_shuffled_performance.csv'
...
for x in range(1, 1001):
    ...
    for fold, (train_index, test_index) in enumerate(loo.split(X_all)):
        ...
        mlp = MLPClassifier(
            ...
            hidden_layer_sizes=(32,32), #mouse
			activation='relu',
			alpha=1e-3,
        ...
        all_decision_scores.extend(prob)
    ...
    experiment_records.to_csv(f'./experiment_details/mouse/mlp/lung/lung_experiment_details_{x}.csv', index=False)
